...
//*****************************************************
Sprite::Sprite(const int x, const int y) : image(0), clip(0)
{
	setXPos(x);
	setYPos(y);
}
...
//*****************************************************
Sprite::Sprite(const int x, const int y, const std::string filename) : image(0), clip(0)
{
	setXPos(x);
	setYPos(y);
...
//*****************************************************
Sprite::Sprite(const int x, const int y, const std::string filename, const int alpha) : image(0), clip(0)
{
	setXPos(x);
	setYPos(y);
...
//*****************************************************
bool Sprite::load(const std::string& filename, int const r, int const g, int const b)
{
    	//temporary SDL surfaces
	SDL_Surface* loaded = 0;
...
void Sprite::show(SDL_Surface* const destination) const
{
	...
	SDL_BlitSurface(image, clip, destination, &position);
}
